          ...
          <div className="min-w-0">
            ...
            <section id="billing" className="mb-16">
              ...
              <div className="space-y-4 text-zinc-400 text-sm leading-relaxed">
                ...
                <p><span className="text-zinc-300 font-medium">Paid plans.</span> If you subscribe, you authorise our payment processor (Dodo Payments) to charge your selected payment method on a recurring basis at the price displayed at checkout, until you cancel.</p>
