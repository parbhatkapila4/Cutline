      ...
      <div className="max-w-[64rem] mx-auto">
        <div className="text-center mb-14">
            ...
            <span className="italic relative whitespace-nowrap">
              ...
              >
                ...
                <path
                  ...
                  stroke="url(#painpoint-underline)"
                  strokeWidth="2.5"
                  strokeLinecap="round"
                  fill="none"
                />
          ...
          <p className="text-[15px] text-gray-500 max-w-[44ch] mx-auto mt-6 leading-relaxed">
            A single brief routes through five tools and four people. We
            collapse the whole pipeline into one prompt.
          </p>
        </div>
        ...
        <div className="relative grid grid-cols-2 rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-[0_2px_4px_rgba(15,23,42,0.04)] mb-4">
          <div
            className="absolute left-1/2 top-0 bottom-0 -translate-x-1/2 w-px bg-gray-100 pointer-events-none"
            aria-hidden
          />
          <div
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hidden sm:flex items-center justify-center w-7 h-7 rounded-full bg-white border border-gray-200 shadow-[0_2px_8px_rgba(15,23,42,0.08)]"
            aria-hidden
          >
            <svg
              ...
              {[
                {
                  label: "Total time",
                  value: "4 days",
                  sub: "five sequential stages",
                },
                {
                  label: "Headcount",
                  value: "5 people",
                  sub: "brief, copy, voice, visuals, edit",
                },
                {
                  label: "Cost / video",
                  value: "$3,400+",
                  sub: "freelance, tools, overhead",
                },
              ].map((row) => (
                <div key={row.label}>
                  <div className="text-[10.5px] font-medium tracking-[0.14em] text-gray-400 uppercase">
                    {row.label}
                  </div>
                  <div
              ...
              {[
                {
                  label: "Total time",
                  value: "60 seconds",
                  sub: "end to end, in one render",
                },
                {
                  label: "Headcount",
                  value: "1 prompt",
                  sub: "you, typing one sentence",
                },
                {
                  label: "Cost / video",
                  value: "$0.24",
                  sub: "all-in, on the standard plan",
                },
              ].map((row) => (
                <div key={row.label}>
                  <div className="text-[10.5px] font-medium tracking-[0.14em] text-gray-400 uppercase">
        ...
        <div className="text-center text-[11px] font-semibold tracking-[0.16em] text-gray-400 uppercase mb-10 tabular-nums">
          <span className="text-emerald-600">5,760×</span> faster ·{" "}
          <span className="text-emerald-600">14,000×</span> cheaper
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="group relative flex flex-col rounded-2xl border border-gray-200 bg-white p-5 transition-all duration-300 hover:border-gray-300 hover:shadow-[0_20px_40px_-20px_rgba(15,23,42,0.22)] hover:-translate-y-0.5">
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-[0_2px_4px_rgba(15,23,42,0.04)] mb-5 overflow-hidden">
              <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50/60">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10.5px] font-semibold text-gray-700">
                    CUT-204 · Product demo
                  </span>
                </div>
                <span className="text-[9.5px] font-mono text-gray-400 tabular-nums">
                  5 issues
                </span>
              </div>
              <div className="divide-y divide-gray-100">
                {TIME_ROWS.map((row, i) => (
                  ...
                  >
                    {row.status === "active" && (
                      <motion.div
                        className="absolute inset-0 bg-amber-100/40 pointer-events-none"
                    ...
                    <span className="relative text-[10.5px] text-gray-700 flex-1 truncate">
                      {row.stage}
                    </span>
                    <span
                      className={`relative w-4 h-4 rounded-full bg-gradient-to-br ${row.whoColor} ring-1 ring-white text-[7.5px] font-bold text-white/95 flex items-center justify-center shrink-0`}
                    >
                      {row.who[0]}
                    </span>
                    <span className="relative text-[9.5px] font-mono text-gray-500 tabular-nums w-7 text-right shrink-0">
                      {row.time}
                    </span>
                    {row.status === "active" && (
                      <motion.div
                        className="absolute bottom-0 left-0 h-[1.5px] bg-gradient-to-r from-amber-300 via-amber-500 to-amber-400"
                        initial={{ width: "0%" }}
                        animate={{ width: ["0%", "72%", "45%", "88%", "12%", "0%"] }}
                        transition={{
                          duration: 4,
                          repeat: Infinity,
                          ease: "easeInOut",
              ...
              <div className="flex items-center justify-between px-3 py-2 border-t border-gray-100 bg-gray-50/60">
                <span className="text-[9.5px] font-semibold tracking-wider uppercase text-gray-400">
                  Total
                </span>
                <span className="text-[10.5px] font-mono font-semibold text-gray-900 tabular-nums">
                  4d · 100h
                </span>
              </div>
            </div>
            ...
            <p className="text-[12.5px] text-gray-500 leading-relaxed mb-5 flex-1">
              The brief sits on someone&rsquo;s desk while five owners wait
              their turn. One stage blocks the next.
            </p>

            <div className="pt-3 border-t border-gray-100 flex items-baseline justify-between gap-2">
              <span className="text-[9.5px] font-semibold tracking-[0.16em] text-gray-400 uppercase">
                Cutline ships in
              </span>
              <span
          ...
          <div className="group relative flex flex-col rounded-2xl border border-gray-200 bg-white p-5 transition-all duration-300 hover:border-gray-300 hover:shadow-[0_20px_40px_-20px_rgba(15,23,42,0.22)] hover:-translate-y-0.5">
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-[0_2px_4px_rgba(15,23,42,0.04)] mb-5 overflow-hidden">
              <div className="flex items-center justify-between px-3 py-2 border-b border-gray-100 bg-gray-50/60">
                ...
                <span className="text-[9.5px] font-mono text-gray-400 tabular-nums inline-flex items-center gap-1.5">
                  <motion.span
              ...
              <div className="divide-y divide-gray-100">
                {FORMAT_ROWS.map((row, i) => (
                  ...
                  >
                    ...
                    <span className="text-[10.5px] text-gray-700 flex-1 truncate inline-flex items-center gap-1.5">
                      {row.platform}
                      {row.state === "active" && (
                        <motion.svg
                    ...
                    <span className="text-[9.5px] font-mono text-gray-400 tabular-nums shrink-0">
                      {row.res}
                    </span>
                    <span className="text-[9.5px] font-mono text-gray-500 tabular-nums w-12 text-right shrink-0">
                      {row.size}
                    </span>
                    <div className="absolute bottom-0 left-0 right-0 h-[1.5px] bg-gray-100/80">
                      {row.state === "active" ? (
                        <motion.div
                          className="h-full bg-gradient-to-r from-rose-300 via-rose-500 to-rose-400"
                          initial={{ width: "0%" }}
                          animate={{ width: "100%" }}
                          transition={{
                            duration: 4.5,
            ...
            <p className="text-[12.5px] text-gray-500 leading-relaxed mb-5 flex-1">
              Each platform is its own crop, its own re-render, its own QA pass.
              Five jobs for the same idea.
            </p>
          ...
          <div className="group relative flex flex-col rounded-2xl border border-gray-200 bg-white p-5 transition-all duration-300 hover:border-gray-300 hover:shadow-[0_20px_40px_-20px_rgba(15,23,42,0.22)] hover:-translate-y-0.5">
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-[0_2px_4px_rgba(15,23,42,0.04)] mb-5 overflow-hidden">
              ...
              <div className="divide-y divide-gray-100">
                {COST_ROWS.map((row) => (
                  ...
                  >
                    <span className="text-[10.5px] text-gray-700 flex-1 truncate">
                      {row.role}
                    </span>
                    <span className="text-[9.5px] font-mono text-gray-400 tabular-nums w-8 text-right shrink-0">
                      {row.hours}
                    </span>
                    <span className="text-[9.5px] font-mono text-gray-400 tabular-nums w-10 text-right shrink-0">
                      <CountUp to={row.rate} prefix="$" delay={row.delay} duration={0.8} />
                    </span>
                    <span className="text-[10.5px] font-mono font-semibold text-gray-900 tabular-nums w-12 text-right shrink-0">
                      <CountUp to={row.line} prefix="$" delay={row.delay} duration={1} />
                    </span>
                  </motion.div>
                ))}
              </div>
              <div className="flex items-center justify-between px-3 py-2 border-t border-gray-100 bg-gray-50/60">
                ...
                <motion.span
                  className="text-[12px] font-mono font-bold text-gray-900 tabular-nums"
                  animate={{
                    textShadow: [
                      "0 0 0px rgba(15,23,42,0)",
                      "0 0 8px rgba(15,23,42,0.15)",
                      "0 0 0px rgba(15,23,42,0)",
                    ],
                  }}
                  transition={{
                ...
                >
                  <CountUp to={3410} prefix="$" decimals={2} delay={1} duration={1.4} />
                </motion.span>
              </div>
            </div>
            ...
            <p className="text-[12.5px] text-gray-500 leading-relaxed mb-5 flex-1">
              More videos used to mean more editors, more voice talent, more
              producers. The unit economics fall apart.
            </p>
