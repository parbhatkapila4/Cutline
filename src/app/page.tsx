...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-clip">
      <div
        className="absolute inset-x-0 top-0 h-[1000px] pointer-events-none select-none overflow-hidden z-0"
        aria-hidden="true"
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 60% 50%, #9f1239 0%, #500724 40%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #450a0a 0%, #7f1d1d 18%, #991b1b 35%, #b91c1c 50%, #e11d48 70%, #f43f5e 85%, #fb7185 100%)",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #881337 0%, #be123c 28%, #e11d48 52%, #f43f5e 75%, #fda4af 100%)",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #fecdd3 0%, #fda4af 35%, #fb7185 65%, #f43f5e 100%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 40% 50%, #7c3aed 0%, #4f46e5 40%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #6366f1 0%, #7c3aed 20%, #a855f7 40%, #c026d3 60%, #ec4899 80%, #f472b6 100%)",
            transform: "rotate(22deg)",
            transformOrigin: "top center",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #818cf8 0%, #a78bfa 30%, #c084fc 55%, #e879f9 80%, #f0abfc 100%)",
            transform: "rotate(18deg)",
            transformOrigin: "top center",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, #c7d2fe 0%, #e9d5ff 40%, #f5d0fe 70%, #fecdd3 100%)",
            transform: "rotate(15deg)",
            transformOrigin: "top center",
          }}
        />
      ...
      <header className="fixed top-5 left-0 right-0 z-50 flex justify-center px-6 pointer-events-none">
        <div className="relative pointer-events-auto">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 100% at center top, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.06) 30%, rgba(255,255,255,0.02) 60%, transparent 100%)",
              filter: "blur(16px)",
            }}
          />
          ...
          <nav
            ...
            style={{
              boxShadow:
                "0 8px 40px -8px rgba(0,0,0,0.85), 0 1px 0 rgba(255,255,255,0.04) inset, 0 25px 60px -15px rgba(0,0,0,0.7)",
            }}
          >
            <Link
              href="/"
      ...
      <main>
        <section className="pt-28 pb-40 px-6 relative">
          <div className="max-w-4xl mx-auto text-center mb-12 relative z-10">
            <div className="group relative inline-flex items-center gap-2.5 px-5 py-2 rounded-full text-sm font-medium mb-6 overflow-hidden bg-white/4 border border-white/10 text-zinc-200 backdrop-blur-sm hover:border-white/20 transition-all duration-300">
              ...
              <svg
                className="relative w-3.5 h-3.5 text-zinc-500 group-hover:text-zinc-300 transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
            ...
            <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
              Describe what you want: add images (optional) and we&apos;ll make
              a video. No images? We&apos;ll find visuals from the web based on
              your description.
            </p>
          </div>
            ...
            {status === "completed" && videoUrl ? (
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-10 sm:p-16">
                <div className="max-w-lg mx-auto">
                  ...
                  <h3
                    key={stage}
                    className="text-2xl sm:text-3xl font-semibold text-white mb-3 animate-fade-in"
                  >
                    {STAGES[stage]}
                  </h3>
                  ...
                  <div className="space-y-3 mb-8">
                    {STAGES.map((stageName, i) => (
                      ...
                      >
                        ...
                        <span
                          className={`text-sm ${i === stage ? "text-white font-medium" : "text-zinc-500"}`}
                        >
                          {stageName}
                        </span>
                      </div>
                ...
                <div className="grid md:grid-cols-[280px_1fr]">
                  <div className="p-6 md:p-7 border-b md:border-b-0 md:border-r border-white/5 bg-zinc-900/50">
                    ...
                    >
                      ...
                      />
                      <svg
                        className="w-8 h-8 mx-auto mb-3 text-zinc-600"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={1}
                                  ...
                                  >
                                    ...
                                    <div className="min-w-0 flex-1">
                                      <div className="flex items-center gap-2">
                                        <span
                                          className={`text-sm truncate ${isActive ? "text-white font-medium" : "text-zinc-300"}`}
                                        >
                                          {displayLabel}
                                        </span>
                                        {isDefault && (
                  ...
                  <div className="p-6 flex flex-col">
                    <div className="flex-1">
                      ...
                      <div className="mt-6">
                        ...
                        <p className="text-xs text-zinc-600 mt-1">
                          10–60 seconds. Talking object videos over 8s use
                          multiple clips.
                        </p>
                      </div>
              ...
              return (
                ...
                >
                  <div className="rounded-3xl border border-white/8 bg-zinc-900/40 p-8 pb-6 flex flex-col min-h-[540px]">
                    <span className="text-[40px] font-extralight leading-none text-zinc-600 mb-5">
                      1
                    </span>
                    ...
                    <div className="mt-auto pt-10 relative h-[260px]">
                      <div className="absolute left-0 bottom-0 w-[82%] min-h-[140px] bg-zinc-800 border border-white/6 rounded-2xl p-5 shadow-2xl shadow-black/50 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[22px] font-bold text-white tracking-tight leading-none mt-0.5">
                            {d.card1.mainValue}
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="rounded-3xl border border-white/8 bg-zinc-900/40 p-8 pb-6 flex flex-col min-h-[540px]">
                    ...
                    <h3 className="text-[22px] font-bold text-white mb-3 leading-snug whitespace-pre-line">
                      {d.card2.title}
                    </h3>
                    <p className="text-[14px] text-zinc-400 leading-relaxed">
                      {d.card2.desc}
                    ...
                    <div className="mt-auto pt-10 relative h-[200px]">
                      <div className="absolute left-0 top-0 w-[62%] bg-zinc-800 border border-white/6 rounded-2xl overflow-hidden shadow-2xl shadow-black/50 z-10">
                        {d.card2.list.map((item, li) => (
                          <div
                            key={li}
                            className={`flex items-center justify-between px-4 py-2.5 ${li < d.card2.list.length - 1 ? "border-b border-white/5" : ""}`}
                          >
                            <span
                              className={`text-[13px] ${li === 0 ? "font-medium text-white" : item.count ? "text-zinc-400" : "text-zinc-500"}`}
                            >
                              {item.name}
                            </span>
                            {item.count && (
                              <span
                                className={`w-[22px] h-[22px] rounded-full text-[10px] font-bold flex items-center justify-center ${item.active ? "bg-emerald-500/20 text-emerald-400" : "bg-zinc-700 text-zinc-300"}`}
                              >
                                {item.count}
                              </span>
                            )}
        ...
        <section
          ref={howSectionRef}
          id="how"
          className="pt-48 pb-48 px-6 bg-black"
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
              <div
                className="absolute left-[11px] top-0 bottom-0 w-px overflow-hidden"
                aria-hidden="true"
              >
                <div
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-6 pt-8 flex flex-col">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  One pipeline, every time: AI script, shot planning, visuals,
                  and voiceover tuned to the same high bar.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-6 pt-8 flex flex-col">
                  ...
                  <div className="diagram-3d-tumble inline-flex items-center justify-center">
                    ...
                    >
                      <path
                        ...
                        strokeWidth=".75"
                        d="M5.919 43.791h143.957v143.957H5.919zM51.266 15h143.957l-45.347 28.791H5.919z"
                      />
                      <path
                        stroke="white"
                        strokeLinejoin="bevel"
                        strokeWidth=".75"
                        d="M51.266 86.979h143.957l-45.347 28.791H5.919zM51.266 158.957h143.957l-45.347 28.791H5.919z"
                      />
                      <path
                        stroke="white"
                        strokeLinejoin="bevel"
                        strokeWidth=".75"
                        d="M149.876 43.791L195.222 15v143.957l-45.346 28.791zM5.92 43.791L51.265 15v143.957L5.919 187.748zM77.178 43.791L122.525 15v143.957l-45.347 28.791z"
                      />
                    </svg>
                  </div>
                </div>
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  See each stage: Intent, script, shots, and voiceover. So you
                  stay in control from prompt to download.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950/80 p-6 pt-8 flex flex-col">
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Your prompt, your video. Download 1080p with no lock-in use it
                  anywhere, no watermarks.
                </p>
              </div>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-5">
                      <div
                        className={`w-11 h-11 rounded-xl border flex items-center justify-center ${plan.highlighted ? "border-amber-500/40 bg-amber-500/10" : "border-white/10 bg-zinc-900"}`}
                      >
                        {plan.icon === "beginner" && (
                          <svg
                    ...
                    <div
                      className={`rounded-xl border p-5 mt-auto ${plan.highlighted ? "border-amber-500/40 bg-white/3" : "border-white/8 bg-white/2"}`}
                    >
                      <a
                        href={plan.href}
                    ...
                    <div className="p-6 pt-5 pb-0 relative">
                      ...
                      <div className="bg-white rounded-t-xl shadow-2xl shadow-black/30 mx-auto max-w-sm">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-100">
                          ...
                          <button className="text-zinc-400 hover:text-zinc-600 text-lg leading-none">
                            &times;
                          </button>
                        </div>
                ...
                <div className="space-y-3 pt-2">
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${activePainPoint === i ? point.iconBg : "bg-zinc-800/50 text-zinc-500"}`}
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
                        ...
                        <span
                          className={`font-semibold text-[15px] ${activePainPoint === i ? "text-white" : "text-zinc-400"}`}
                        >
                          {point.title}
                        </span>
                      </div>
