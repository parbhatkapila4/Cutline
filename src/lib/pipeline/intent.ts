...
- mainSubject: string or null - The TANGIBLE physical object the video centers on, if and only if the sentence is unambiguously about a specific recognizable physical product, item, or creature that a viewer would expect to see as the visual focus (used downstream to shape a talking cartoon character). Use a short noun phrase (e.g. "espresso machine", "running shoe", "coffee mug", "piston engine"). Set to null for abstract topics — concepts, processes, services, frameworks, advice, copywriting tips, marketing strategies, software/apps/SaaS unless the visual subject literally IS the physical product, generic categories of people, or anything where there is no obvious physical thing to focus on. When in doubt, return null. Examples: "Explain how a piston engine works" -> "piston engine". "Introduce our espresso machine" -> "espresso machine". "Pitch my SaaS app in 45 seconds" -> null. "Tips for better copywriting" -> null. "How to start with a problem and offer a solution" -> null. "Why a coffee mug makes the perfect gift" -> "coffee mug".
